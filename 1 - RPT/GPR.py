'''
This script provides helper functions to run non-parametric gaussian process regression to learn the relationship between RC parameters and
operating conditions.These helper functions are used in lookup_table.py.
'''
